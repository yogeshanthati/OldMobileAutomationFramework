...
public abstract class Page extends Common{
	 ...
	 * @param report
	 */
	protected Page(AppiumDriver<WebElement> driver2,Data data) {
		this.driver=driver2;	
		this.data = data;
	...
	public void JSDoubleTapByCoordinates(int x,int y) {
	...
	public void JSDragFromToForDuration(int FromX,int FromY,int ToX,int ToY, int Duration) {
	...
	public void JSTapByCoordinates(int x,int y) {
	...
	public void JSTouchAndHoldForDuration(MobileElement we,int Duration) {
	...
	public void JSTwoFingerTap(MobileElement we) {
	...
	public void JSZoomAndPinch (int Scale ,int Velocity) {
	...
	public void LongPressOnElement(MobileElement we) {
		try {
	...
	public void  PinchOnElement(MobileElement we,String elemName) {
		try {
			Thread.sleep(4000);
	...
	public void ScrollToView(MobileElement we) {
	...
	public void SelectPickerWheel(MobileElement we,String Direction) {
		try {
			if(isElementPresent(we))
			{
	 ...
	 * Modified By  :
	 ***/
	public void TapOnElement(MobileElement we,String elementName) {
		try {
			if (isElementPresent(we))
			{
	...
	public void TouchAndHoldOnElement(MobileElement we,int duration ) {   //test
		try {
	...
	public void TouchMultipleTimesOnElement(MobileElement we, String ElementName,int noOfTimes) {
		try {
			if(isElementPresent(we))
			{																												//test
	...
	public void ZoomOnElement(MobileElement we, String ElementName) {
